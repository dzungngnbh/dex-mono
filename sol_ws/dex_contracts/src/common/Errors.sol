...
string constant ERR_INVALID_ADDR = "IA";
...
string constant ERR_INVALID_TX_TYPE = "ITT";
...
// bad product config via weights
string constant ERR_BAD_RISK_STORE = "BRS";
...
string constant ERR_ONLY_SEQUENCER = "OS";
...
string constant ERR_WRONG_SENDER = "SMWS";
string constant ERR_INVALID_NONCE = "IN";
...
string constant ERR_INVALID_ORDER = "IO";
